...
public class GlobalRequestWithProgress extends AsyncTask<String, Void, Void> {


    Context context;
    ProgressDialog progressDialog;

    public GlobalRequestWithProgress(Context context, ProgressDialog progressDialog){
